...
<body>
<% String url = "jdbc:mysql://localhost:3306/dynamictest";
...
PreparedStatement ps = con.prepareStatement("select trans_id,credit,debit, balance from my_trans order by trans_id desc limit 5");
ResultSet rs = ps.executeQuery();
PreparedStatement ps2 = con.prepareStatement("select balance from my_trans order by trans_id desc limit 1");
